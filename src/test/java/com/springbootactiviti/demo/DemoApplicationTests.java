...
public class DemoApplicationTests {
    ...
    public void findHistoricTasks() {
        ...
        datas = historyService.createHistoricTaskInstanceQuery()
                .taskDueAfter(DateUtil.parse("2020-10-11 06:00:00")).list();
        System.out.println("使用taskDueAfter方法查询：" + datas.size());
        datas = historyService.createHistoricTaskInstanceQuery()
                .taskDueBefore(DateUtil.parse("2022-10-11 06:00:00")).list();
        System.out.println("使用taskDueBefore方法查询：" + datas.size());
        datas = historyService.createHistoricTaskInstanceQuery()
                .taskDueDate(DateUtil.parse("2020-10-11 06:00:00")).list();
